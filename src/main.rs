...
// Final, fully-corrected version of the Claude Config Manager.
...
const APP_DIR_NAME: &str = ".claude-config-manager";  // 应用程序目录
...
fn main() -> Result<(), eframe::Error> {
    ...
    eframe::run_native("Claude Code 配置管理器", options, Box::new(|cc| Box::new(ConfigManagerApp::new(cc))))
}
